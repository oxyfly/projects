...
<html lang="en">
  ...
  <meta name="request-id" content="10C7:32E54:5F7B974:935B8EF:5C696721" data-pjax-transient>
...
<meta class="js-ga-set" name="dimension1" content="Logged Out">
    ...
    <meta name="js-proxy-site-detection-payload" content="">

    <meta name="enabled-features" content="UNIVERSE_BANNER,MARKETPLACE_PLAN_RESTRICTION_EDITOR,MARKETPLACE_BROWSING_V2">

  <meta name="html-safe-nonce" content="4cda315d5632b1c734f108f9c3032b0880efdbe4">
    ...
    <!-- '"` --><!-- </textarea></xmp> --></option></form><form class="js-site-search-form" data-scope-type="Repository" data-scope-id="1337658" data-scoped-search-url="/scottjehl/Respond/search" data-unscoped-search-url="/search" action="/scottjehl/Respond/search" accept-charset="UTF-8" method="get"><input name="utf8" type="hidden" value="&#x2713;" />
      <label class="form-control header-search-wrapper header-search-wrapper-jump-to position-relative d-flex flex-justify-between flex-items-center js-chromeless-input-container">
        <input type="text"
          ...
          aria-label="Search"
          data-jump-to-suggestions-path="/_graphql/GetSuggestedNavigationDestinations#csrf-token=pgwxqmCjpF8Bwhln9X3tjGFf5s6fY/+sXmqTfY7NYPjnJw63I+hGP4dhQOIKalQGArkvG37aB3ZlaA3jg3gyVA=="
          spellcheck="false"
          autocomplete="off"
          >
  ...
  <a tabindex="-1" class="no-underline d-flex flex-auto flex-items-center jump-to-suggestions-path js-jump-to-suggestion-path js-navigation-open p-2" href="">
    ...
    <div aria-hidden="true" class="border rounded-1 flex-shrink-0 bg-gray px-1 text-gray-light ml-1 f6 d-none d-on-nav-focus js-jump-to-badge-jump">
      ...
      <span class="d-inline-block ml-1 v-align-middle">↵</span>
        ...
        <a class="HeaderMenu-link no-underline mr-3" href="/login?return_to=%2Fscottjehl%2FRespond%2Fblob%2Fmaster%2Fdest%2Frespond.min.js" data-ga-click="(Logged out) Header, clicked Sign in, text:sign-in">Sign&nbsp;in</a>
...
<nav class="reponav js-repo-nav js-sidenav-container-pjax container"
  ...
  <span itemscope itemtype="http://schema.org/ListItem" itemprop="itemListElement">
    ...
    <a class="js-selected-navigation-item reponav-item" data-selected-links="repo_graphs repo_contributors dependency_graph pulse alerts security people /scottjehl/Respond/pulse" href="/scottjehl/Respond/pulse">
  ...
  <div class="repository-content ">
    ...
    <!-- blob contrib key: blob_contributors:v21:8a2f61f6cbcae4a5a6a1d1510fc1dd13 -->
      ...
      <div class="signup-prompt p-4 text-center mb-4 rounded-1">
        <div class="position-relative">
          <!-- '"` --><!-- </textarea></xmp> --></option></form><form action="/site/dismiss_signup_prompt" accept-charset="UTF-8" method="post"><input name="utf8" type="hidden" value="&#x2713;" /><input type="hidden" name="authenticity_token" value="lDyyUDfYR2oHuJNhItA1qoxhyw60QsDeI4dVKlLWwVcf8zld/ygLrhfM5LlSnoFUSfX8+aLnIQpyWHQOw3j3RQ==" />
...
<details class="details-reset details-overlay select-menu branch-select-menu float-left">
  ...
  <details-menu class="select-menu-modal position-absolute" style="z-index: 99;" src="/scottjehl/Respond/ref-list/master/dest/respond.min.js?source_action=show&amp;source_controller=blob" preload>
...
<div class="footer container-lg px-3" role="contentinfo">
  <div class="position-relative d-flex flex-justify-between pt-6 pb-2 mt-6 f6 text-gray border-top border-gray-light ">
    <ul class="list-style-none d-flex flex-wrap ">
      <li class="mr-3">&copy; 2019 <span title="0.22077s from unicorn-686c564448-fg5hq">GitHub</span>, Inc.</li>
