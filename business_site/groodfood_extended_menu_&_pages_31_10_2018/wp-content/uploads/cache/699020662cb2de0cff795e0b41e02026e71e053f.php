<header class="banner">
  ...
  <div class="container nav-wrap">
    ...
    <nav class="nav-primary">
        ...
        <a href="#">
          <img class="logo" src="<?= App\asset_path('images/page-1/logo.png'); ?>" alt="Logo" title="">
        </a>
      </figure>
...
<div id="carouselExampleSlidesOnly" class="carousel slide" data-ride="carousel">
    <div class="carousel-inner">
        <div class="carousel-item active">
            <img class="d-block w-100" src="<?= App\asset_path('images/page-1/bg_1.jpg'); ?>"
                 alt="Slide" title="">
        ...
        <div class="carousel-item">
            <img class="d-block w-100" src="<?= App\asset_path('images/page-1/bg_2.jpg'); ?>" alt="Slide"
                 title="">
            <div class="carousel-caption d-block">
        ...
        <div class="carousel-item">
            <img class="d-block w-100" src="<?= App\asset_path('images/page-1/bg_3.jpg'); ?>" alt="Slide"
                 title="">
            <div class="carousel-caption d-block">
                <h3 class="slide-food-descriprion">Каша ТМ Гродфуд это классическая консервированная каша с содержанием
                    мяса более 37%. Остается только разогреть и на Вашем столе готовое сытное блюдо.</h3>
