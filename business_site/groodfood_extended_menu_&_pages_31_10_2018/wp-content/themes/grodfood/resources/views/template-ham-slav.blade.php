        ...
        <div class="container">
            <div class="row">
                <div class="col-md-6 col-xl-6">
                    <div class="ham-product-block-1">
                        <div class="ham-product-img">
                            <img src="/wp-content/themes/grodfood/dist/images/product-pot/ham-slav/001.jpg" alt="Image">
                        </div>
                    </div>
                </div>
                <div class="col-md-6 col-xl-6">
                    <div class="ham-product-block-1">
                        <h3>Консервы мясные стерилизованные. "Славянская"</h3>
                ...
                <div class="col-md-6 col-xl-6">
                    <div class="ham-product-block-1">
                        <div class="ham-product-img">
                            <img src="/wp-content/themes/grodfood/dist/images/product-pot/ham-slav/002.jpg" alt="Image">
                        </div>
                    </div>
                </div>
                <div class="col-md-6 col-xl-6">
