{{--
  Template Name: Pate-mushroom Template
--}}
...
@section('content')
    ...
    <nav aria-label="breadcrumb" class="breadcrumbs">
        <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item"><a href="/pate-mushroom">С грибами</a></li>
        </ol>
    </nav>
        ...
        <div class="container">
            <div class="row">
                <div class="col-md-6 col-xl-6">
                    <div class="pate-product-block-1">
                        <div class="pate-product-img">
                            <img src="/wp-content/themes/grodfood/dist/images/product-pot/pate-mushroom/001.jpg" alt="Image">
                        </div>
                    </div>
                </div>
                <div class="col-md-6 col-xl-6">
                    <div class="pate-product-block-1">
                        <h3>Куриный с грибами</h3>
                ...
                <div class="col-md-6 col-xl-6">
                    <div class="pate-product-block-1">
                        <div class="pate-product-img">
                            <img src="/wp-content/themes/grodfood/dist/images/product-pot/pate-mushroom/002.jpg" alt="Image">
                        </div>
                    </div>
                </div>
                <div class="col-md-6 col-xl-6">
