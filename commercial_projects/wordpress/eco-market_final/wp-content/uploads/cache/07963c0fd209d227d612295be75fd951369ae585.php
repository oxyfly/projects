        ...
        <nav class="nav-primary">
            ...
            <div class="nav-product-block animated fadeInUp delay-4s">
                <ul>
                    <li>
                        <a href="#">
                            <img src="/wp-content/themes/ecomarket/dist/images/icons/search.svg" title="Search"
                                 alt="Image">
                        </a>
                    </li>
                    <li>
                        <a href="#">
                            <img src="/wp-content/themes/ecomarket/dist/images/icons/bag.svg" title="Basket"
                                 alt="Image">
                        </a>
                    </li>
                </ul>
