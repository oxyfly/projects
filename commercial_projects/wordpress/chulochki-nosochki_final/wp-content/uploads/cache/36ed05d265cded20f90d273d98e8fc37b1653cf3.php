                    ...
                    <div id="carouselExampleIndicators" class="carousel slide" data-ride="carousel">
                        ...
                        <div class="carousel-inner">
                            <div class="carousel-item active">
                                <img class="d-block w-100" src="/wp-content/themes/chulochki/dist/images/slider-bg.jpg"
                                     alt="First slide">
            ...
            <div class="row">
                <div class="col-md-6 col-xl-4 product-block-hit-col">
                    <a href="/product-category/actions/">
                        <div class="product-block-hit-wrap">
                            <img src="/wp-content/themes/chulochki/dist/images/product-block-photo/image-1.png"
                                 alt="Image"
                                 title="Акции">
                ...
                <div class="col-md-6 col-xl-4 product-block-hit-col">
                    <a href="/product-category/newest/">
                        <div class="product-block-hit-wrap">
                            <img src="/wp-content/themes/chulochki/dist/images/product-block-photo/image-2.png"
                                 alt="Image"
                                 title="Новинки">
                ...
                <div class="col-md-6 col-xl-4 product-block-hit-col">
                    <a href="#">
                        <div class="product-block-hit-wrap">
                            <img src="/wp-content/themes/chulochki/dist/images/product-block-photo/image-3.png" alt="">
            ...
            <div class="row">
                <div class="col-md-6 col-xl-3">
                    <div class="product-recommend-block product-recommend-block-pos product-recommend-block-pos-bottom">
                        <a href="/product/honey-name-1">
                            <div class="product-recommend-img">
                                <img src="/wp-content/themes/chulochki/dist/images/product-img.jpg" alt="Image"
                                     title="Product">
                            </div>
                        </a>
                        <div class="product-title-link">
                            <a href="/product/honey-name-1"><p class="product-title"></p>product</a>
                        </div>
                ...
                <div class="col-md-6 col-xl-3">
                    <div class="product-recommend-block product-recommend-block-pos product-recommend-block-pos-bottom">
                        ...
                        <div class="product-title-link">
                            <a href="/product/honey-name-2"><p class="product-title"></p>product</a>
                        </div>
                        <p class="product-price">Цена: 10,00 руб.</p>
                        <div class="btn-product-wrap">
                            <a class="btn-product" href="#">В корзину</a>
                ...
                <div class="col-md-6 col-xl-3">
                    <div class="product-recommend-block product-recommend-block-pos product-recommend-block-pos-bottom">
                        ...
                        <div class="product-title-link">
                            <a href="/product/honey-name-3"><p class="product-title"></p>product</a>
                        </div>
                        <p class="product-price">Цена: 10,00 руб.</p>
                        <div class="btn-product-wrap">
                            <a class="btn-product" href="#">В корзину</a>
                ...
                <div class="col-md-6 col-xl-3">
                    <div class="product-recommend-block product-recommend-block-pos product-recommend-block-pos-bottom">
                        ...
                        <div class="product-title-link">
                            <a href="/product/honey-name-4"><p class="product-title"></p>product</a>
                        </div>
                        <p class="product-price">Цена: 10,00 руб.</p>
                        <div class="btn-product-wrap">
                            <a class="btn-product" href="#">В корзину</a>
