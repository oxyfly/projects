<?php $__env->startSection('content'); ?>
    ...
    <nav aria-label="breadcrumb" class="breadcrumbs">
        <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item"><a href="http://grodfood.ruslanyushkevich.com/ham-euro/">Европейская</a></li>
        </ol>
    </nav>
        ...
        <div class="container">
            <div class="row">
                <div class="col-md-6 col-xl-6">
                    <div class="ham-product-block-1">
                        <div class="ham-product-img">
                            <img src="/wp-content/themes/grodfood/dist/images/product-pot/ham-euro/001.jpg" alt="Image">
                        </div>
                    </div>
                </div>
                <div class="col-md-6 col-xl-6">
                    <div class="ham-product-block-1">
                        <h3>Консервы мясные стерилизованные. "Европейская"</h3>
                ...
                <div class="col-md-6 col-xl-6">
                    <div class="ham-product-block-1">
                        <div class="ham-product-img">
                            <img src="/wp-content/themes/grodfood/dist/images/product-pot/ham-euro/002.jpg" alt="Image">
                        </div>
                    </div>
                </div>
                <div class="col-md-6 col-xl-6">
