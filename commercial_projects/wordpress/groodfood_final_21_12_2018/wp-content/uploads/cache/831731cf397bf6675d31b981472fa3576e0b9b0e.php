<?php $__env->startSection('content'); ?>
    ...
    <section class="about-awards-common">
        <section class="ornament ornament-about-common">
                    ...
                    <div class="row">
                        <div class="col">
                            <div class="about-company-logo">
                                <img src="/wp-content/themes/grodfood/dist/images/footer-logo.png" alt="">
                            </div>
                            ...
                            <h5 class="about-common-title">Достижение поставленной цели по производству продукции
                                высокого
                            ...
                            <ul class="about-common-list">
                                <li>Внедрением систем менеджмента качества и безопасности, соответствующих требованиям
                                    СТБ ИСО 9001-2015, СТБ ИСО 22000-2006;
                                </li>
                            ...
                            <h5 class="about-common-title">СООО «Квинфуд» выпускает мясную консервацию в четырех
                                категориях:
                            </h5>
                            <ul class="about-common-list">
                                <li><a href="/stew-page">«Консервы мясные» (Тушенка) ТМ Гродфуд</a></li>
                                <li><a href="/porridge-page">«Консервы мясорастительные» (Каша с мясом) ТМ Гродфуд</a>
                                </li>
                            ...
                            <p class="about-common-description">Продукция ТМ "Гродфуд" реализуется на территории
                                <strong><a
                                            href="#">Республики Беларусь, Российской Федерации, Казахстана, Грузии,
