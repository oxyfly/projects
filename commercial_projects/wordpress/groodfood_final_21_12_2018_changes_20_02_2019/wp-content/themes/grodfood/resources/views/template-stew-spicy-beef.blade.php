{{--
  Template Name: Stew-spicy-beef Template
--}}
...
@section('content')
    ...
    <nav aria-label="breadcrumb" class="breadcrumbs">
        <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item"><a href="/stew-spicy-beef">Говядина со специями</a></li>
        </ol>
    </nav>
    <section class="stew-product-title">
        <div class="container">
            <div class="row">
                <div class="col-12">
                    <div>
                        <h3 class="stew-product-title-name">Говядина со специями</h3>
        ...
        <div class="container">
            <div class="row">
                <div class="col-md-6 col-xl-4">
                    <div class="stew-product-block">
                        <div class="stew-product-img">
                            <img src="/wp-content/themes/grodfood/dist/images/product-pot/stew-spicy/05.png" alt="Image">
                        </div>
                        <h3>С перцем чили</h3>
                ...
                <div class="col-md-6 col-xl-4">
                    <div class="stew-product-block">
                        <div class="stew-product-img">
                            <img src="/wp-content/themes/grodfood/dist/images/product-pot/stew-spicy/06.png"
                                 alt="Image">
                        </div>
                        <h3>С паприкой</h3>
                        <ul class="stew-product-description">
                ...
                <div class="col-md-6 col-xl-4">
                    <div class="stew-product-block">
                        <div class="stew-product-img">
                            <img src="/wp-content/themes/grodfood/dist/images/product-pot/stew-spicy/07.png"
                                 alt="Image">
                        </div>
                ...
                <div class="col-md-6 col-xl-4">
                    <div class="stew-product-block">
                        <div class="stew-product-img">
                            <img src="/wp-content/themes/grodfood/dist/images/product-pot/stew-spicy/08.png"
                                 alt="Image">
                        </div>
