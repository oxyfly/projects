<?php $__env->startSection('content'); ?>
    ...
    <nav aria-label="breadcrumb" class="breadcrumbs">
        <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item"><a href="http://grodfood.ruslanyushkevich.com/ham-piquant/">Пикантная</a></li>
        </ol>
    </nav>
                ...
                <div class="col-md-6 col-xl-6">
                    <div class="ham-product-block-1">
                        <div class="ham-product-img">
                            <img src="/wp-content/themes/grodfood/dist/images/product-pot/ham-piquant/001.jpg" alt="Image">
                        </div>
                    </div>
                </div>
                <div class="col-md-6 col-xl-6">
                    <div class="ham-product-block-1">
                        <h3>Консервы мясные стерилизованные. "Пикантная"</h3>
                        <ul class="ham-product-description-1">
                            <li>Упаковка: ламистер</li>
                            <li>Масса нетто, г: 110</li>
                            <li>Срок годности: 2 года</li>
                            <li>Условия хранения: При температуре от 0 С до +20 С, при относительной влажности воздуха не более 75%</li>
                        </ul>
                    </div>
                </div>
                <div class="col-md-6 col-xl-6">
                    <div class="ham-product-block-1">
                        <div class="ham-product-img">
                            <img src="/wp-content/themes/grodfood/dist/images/product-pot/ham-piquant/002.jpg" alt="Image">
                        </div>
                    </div>
                </div>
                <div class="col-md-6 col-xl-6">
