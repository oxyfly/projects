        ...
        <div class="container">
            <div class="row">
                <div class="col-xl-12">
                    ...
                    <p class="about-text">Мы заботимся о здоровом будущем людей нашей страны, поэтому создали этот
                        магазин
                        для
                        Вас!
                    ...
                    <p class="about-text">Выбирая органические продукты питания, натуральные косметические и
                        хозяйственные
                        средства
