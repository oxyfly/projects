            ...
            <div class="row">
                <div class="col-md-6 col-xl-4 product-block-hit-col">
                    <div class="product-block-hit-wrap">
                        <img src="/wp-content/themes/ecomarket/dist/images/product-block-photo/image-1.png" alt="">
                        <p class="product-block-hit-description">adasdasdsadsadada</p>
                    </div>
                </div>
                <div class="col-md-6 col-xl-4 product-block-hit-col">
                    <div class="product-block-hit-wrap">
                        <img src="/wp-content/themes/ecomarket/dist/images/product-block-photo/image-2.png" alt="">
                        <p class="product-block-hit-description">adasdasdsadsadada</p>
                    </div>
                </div>
                <div class="col-md-6 col-xl-4 product-block-hit-col">
