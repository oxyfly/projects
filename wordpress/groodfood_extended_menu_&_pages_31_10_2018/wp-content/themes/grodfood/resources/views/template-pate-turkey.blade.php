{{--
  Template Name: Pate-turkey Template
--}}
...
@section('content')
    ...
    <nav aria-label="breadcrumb" class="breadcrumbs">
        <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item"><a href="/pate-turkey">Индюшиный</a></li>
        </ol>
    </nav>
        ...
        <div class="container">
            <div class="row">
                <div class="col-md-6 col-xl-6">
                    <div class="pate-product-block-1">
                        <div class="pate-product-img">
                            <img src="/wp-content/themes/grodfood/dist/images/product-pot/pate-turkey/001.jpg" alt="Image">
                        </div>
                    </div>
                </div>
                <div class="col-md-6 col-xl-6">
                    <div class="pate-product-block-1">
                        <h3>Индюшиный печеночный</h3>
                ...
                <div class="col-md-6 col-xl-6">
                    <div class="pate-product-block-1">
                        <div class="pate-product-img">
                            <img src="/wp-content/themes/grodfood/dist/images/product-pot/pate-turkey/002.jpg" alt="Image">
                        </div>
                    </div>
                </div>
                <div class="col-md-6 col-xl-6">
