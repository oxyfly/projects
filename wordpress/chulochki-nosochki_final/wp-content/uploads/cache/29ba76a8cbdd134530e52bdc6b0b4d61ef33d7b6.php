            ...
            <div class="row">
                <div class="col-md-6 col-xl-4 product-block-hit-col">
                    <div class="product-block-hit-wrap">
                        <img src="/wp-content/themes/chulochki/dist/images/product-block-photo/image-1.png" alt="">
                        <p class="product-block-hit-description">adasdasdsadsadada</p>
                    </div>
                </div>
                <div class="col-md-6 col-xl-4 product-block-hit-col">
                    <div class="product-block-hit-wrap">
                        <img src="/wp-content/themes/chulochki/dist/images/product-block-photo/image-2.png" alt="">
                        <p class="product-block-hit-description">adasdasdsadsadada</p>
                    </div>
                </div>
                <div class="col-md-6 col-xl-4 product-block-hit-col">
                ...
                <div class="col-md-6 col-xl-3">
                    <div class="product-recommend-block product-recommend-block-pos product-recommend-block-pos-bottom">
                        ...
                        <div class="product-title-link">
                            <a href="#"><p class="product-title"></p>Мед натуральный</a>
                        </div>
                        <p class="product-value">600 г.</p>
                        <p class="product-price">Цена: 44,00 руб.</p>
