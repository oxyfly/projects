    ...
    <div class="container">
        <div class="row">
            <div class="col-xl-12">
                ...
                <p class="delivery-text">Выбрать способ доставки и удобное время получения покупок можно в корзине на
                    этапе оформления заказа.
                </p>

                <h3 class="delivery-title">Условия доставки курьерами</h3>
                <p class="delivery-text"><strong>Срок доставки – ближайшие понедельник, среда, пятница</strong> после
                    подтверждения
                    заказа.
                </p>
                ...
                <p class="delivery-text">К примеру:<br>
                    - Срок доставки заказа в выбранный вами фирменный магазин - до 2 рабочих дней после подтверждения
                    заказа.
                    <br>
